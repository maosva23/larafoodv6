...
@section ('content_header')
    <h1>
        ...
        <a class="btn btn-dark" href="{{route('permissions.profiles.create', $profile->id)}}">
...
{{--                                --}}{{-- VER --}}
{{--                            </a>--}}
                            <a href="{{ route('permissions.profiles.dettach', [$profile->id, $permission->id]) }}" class="btn btn-sm btn-danger" title="Desvincular">
