...
@section ('content_header')
    <h1>
        ...
        <a class="btn btn-dark" href="{{route('profiles.plan.create', $plan->id)}}">
...
{{--                                --}}{{-- VER --}}
{{--                            </a>--}}
                            <a href="{{ route('profiles.plan.dettach', [$plan->id, $profile->id]) }}" class="btn btn-sm btn-danger" title="Editar">
